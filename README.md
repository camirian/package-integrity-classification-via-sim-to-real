...
├── README.md
├── data/
│   └── synthetic-dataset/       # generated by Phase 2
├── models/                      # training artefacts (weights, ONNX)
├── tests/
├── phase-1-asset-and-scene-creation/
│   ├── assets/                  # box-pristine.usd, box-dented.usd, box-crushed.usd
│   ├── scenes/
│   └── scripts/
│       ├── create-pristine-box.py
│       ├── deform-box.py
│       └── crush-box.py
