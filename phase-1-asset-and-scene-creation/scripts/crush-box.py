...
rigid_sphere_cfg = sim_utils.SphereCfg(
    ...
    radius=0.1,
    mass=150.0 # Heavier mass to cause more deformation
)
...
omni.kit.commands.execute('CreateUsd',
    dest_path='\\wsl$\Ubuntu\home\caaren\package_integrity_classification_via_sim-to-real\phase_1_asset_and_scene_creation\assets\box_crushed.usd',
